...
public:
    ...
    void withdrawAmount()
    {
        ...
        {
            cout << "Withdrawal not possible as amount in balance would fall behind the minimum balance amount" << endl;
            return;
        }
        balance -= withdraw;
    ...
    void operations()
    {
        ...
        while (ch)
        {
            cout << "Choose from the following operations that you want to perform on your Savings Account";
...
public:
    ...
    void withdrawAmount()
    {
        ...
        {
            cout << "\nOverdraft has reached maximum amount permissible. Withdrawak not possible." << endl;
            return;
        }
        float withdraw;
